...
// Right pane: Property tab now shows live PropertyGrid from Supabase
...
export function IntelligencePanel() {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      >
        {/* Tab nav */}
        <div className="px-4 py-2 border-b border-slate-700 bg-slate-900 flex-shrink-0">
        ...
        {/* Tab content - flex-1 to fill panel */}
        <div className="flex-1 overflow-hidden">
          {/* ── PROPERTY TAB: live Supabase grid ── */}
          <TabsContent value="property" className="m-0 h-full">
            <PropertyGrid county="brevard" />
          </TabsContent>
          ...
          <TabsContent value="pipeline" className="m-0 h-full overflow-auto p-4">
            <div className="space-y-4">
              <h2 className="text-lg font-semibold text-white font-display">Pipeline Status</h2>
              <PipelineProgress stages={MOCK_STAGES} currentStage="lien_priority" />
            </div>
          </TabsContent>

          <TabsContent value="reports" className="m-0 h-full overflow-auto p-4">
